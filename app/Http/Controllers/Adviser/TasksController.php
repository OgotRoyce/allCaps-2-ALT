...
class TasksController extends Controller
{
    ...
    public function index()
    {
        $tasks = Task::all();
        $acts = Activity::all();
        return view('Adviser.Task.index', ['tasks' => $tasks, 'acts' => $acts]);
    }
    ...
    public function create($id)
    {
        ...
        return view('Adviser.Task.create', ['tasks' => $tasks]);
    ...
    public function store(Request $request)
    {
       ...
       if ($request->hasFile('attachments')) {
        ...
        return redirect()->route('adviser_task');
    }
    ...
    public function show($taskId)
    {
        ...
        return view('Adviser.Task.view', compact('acts'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('Adviser.Task.edit', compact('acts'));
    }
