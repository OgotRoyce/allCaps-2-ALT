...
<body>
    ...
    <form class="form_container mx-auto" action="{{ route('auth') }}" method="post">
        {!! csrf_field() !!}
        ...
        @if (session('warning'))
    <div id="warning-message" class="alert alert-danger" align="center" style="width: 100%">
        {{ session('warning') }}
    </div>
@endif
        <br>
        <div class="input_container">
            ...
            <input placeholder="Email" title="Input Email" name="email" type="text" class="input_field"
                id="email">
        </div>
        ...
        <div class="input_container">
            ...
            <input placeholder="Password" title="Input Password" name="password" type="password" class="input_field"
                id="password">  
        </div>

            <div class="form-check" >
                <input class="form-check-input" type="checkbox" value="" id="password" onclick="togglePassword()">
                <label class="form-check-label" for="auth-remember-check" onclick="togglePassword()">Show password</label>
            </div>

            <script>
                function togglePassword() {
                    var passwordInput = document.getElementById("password");
                    var passwordAddon = document.getElementById("password");
