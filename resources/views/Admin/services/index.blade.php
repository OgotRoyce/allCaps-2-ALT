...
<style>
  ...
  .task-img {
    margin-right: 0.5rem; /* adjust this value to increase/decrease the space between the icon and the text */
    font-size: 3rem; /* adjust this value to change the size of the icon */
    color: #ff6600;
}
    .project-column {
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="header mt-2"><i class="fas fa-list"></i> Tasks
                            <span class="badge badge-secondary"><span style="font-weight: 300; color: #bfbfbf;">List of
                                    complete and pending tasks</span></h5>
                                                <a href="#">
                                                  <button type="button" style="width:100%" class="btn btn-outline-danger float-right">+ Create New Task</button>
                                                </a>
                    </div>
                        ...
                        <main class='project'>
                            ...
                            <i class="task-img fas fa-clipboard-list"></i>
                                ...
                                <div class='task'>
                                    ...
                                    <span><date datetime="2021-11-24T20:00:00"><i class="task-icon fas fa-flag"></i>Nov 24</date></span>
